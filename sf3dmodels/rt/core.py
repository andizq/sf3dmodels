...
class MakeDatatab(object):
    ...
    def _get_available_props(cls, self):
        """
        Returns the sorted available physical properties to be read by the RT codes.
        """
...
class Lime(MakeDatatab):
    ...
    +----------+----------+--------------------------+
    |abundance | 16       |Molecular abundance       |
    +----------+----------+--------------------------+
...
Radmc3dRT = Radmc3dDefaults #Backward compatibility
