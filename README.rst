...
The package includes the standard LIME v1.9.5 + an additional feature for the sf3dmodels users. 
...
(have a look at the `installation <https://github.com/andizq/lime/tree/sf3dmodels>`_ notes).
