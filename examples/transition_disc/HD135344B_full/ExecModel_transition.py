...
matplotlib.rc('xtick', labelsize=SMALL_SIZE+2) 
matplotlib.rc('ytick', labelsize=SMALL_SIZE+2)
...
ax1.plot(phi_const+phi_plot_0, R_plot/u.au, lw=3.5, ls='--', color='blue',  alpha=1.0)
ax1.plot(phi_const+phi_plot_1, R_plot/u.au, lw=3.5, ls='-', color='blue', alpha=0.7)
ax1.plot(phi_sine, R_plot/u.au, lw=3.5, ls=':', color='blue', alpha=0.7)
ax1.plot(phi_sine, R_plot/u.au, lw=3.5, ls=':', color='blue', alpha=0.7)
ax1.plot(phi, R_const+R_plot_0/u.au, lw=3.5, ls='-', color='darkorange', alpha=1.0)

ax1.set_ylabel('Disc polar map', labelpad=40)
...
ax0.plot(R_plot/u.au, dens_0/1e6, lw=3.5, ls='--', color='green')
ax0.plot(R_plot/u.au, dens_1/1e6, lw=3.5, ls='-', color='green', alpha=0.7)
ax0.plot(R_plot/u.au, dens_2/1e6, lw=3.5, ls=':', color='green', alpha=0.7)
ax0.set_xlabel('au')
ax0.xaxis.set_label_position('top') 
ax0.xaxis.set_minor_locator(AutoMinorLocator())
ax0.set_yscale('log')
ax0.set_ylabel(r'H$_2$ density [cm$^{-3}$]', labelpad=15)
...
ax0b.plot(R_plot/u.au, gtd_0, lw=3.5, ls='--', color='red')
ax0b.plot(R_plot/u.au, gtd_1, lw=3.5, ls='-', color='red', alpha=0.7)
ax0b.plot(R_plot/u.au, gtd_2, lw=3.5, ls=':', color='red')
...
ax2.plot(phi*180/np.pi, gtd_0, lw=3.5, ls='-', color='red')
