...
else: Arho = 15.0  # (Mdisk=0.106*1.4=Msun=0.149Msun)
...
density = Model.density_Hamburgers(RStar, H0sf, Rd, Rho0, Arho, GRID, rho_min = 1.0,
...
#-----------------------------
prop = {'dens_Hplus': np.ones(GRID.NPoints),
...
lime = rt.Lime(GRID)
lime.submodel(prop, output='disc.dat')
