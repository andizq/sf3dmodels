...
input(inputPars *par, image *img){
   ...
   */
  par->radius                   = 0.8*PC; 
  par->minScale                 = 0.01*PC;
  par->pIntensity               = 32000; 
  ...
  img[i].filename               = "img_default_CO_J1-0_LTE_jypxl.fits"; //Output file
  ...
  img[i].source_vel             = 0;              // source velocity in m/s                                        
  img[i].unit                   = 1;              // 0:Kelvin 1:Jansky/pixel 2:SI 3:Lsun/pixel 4:tau                      
  img[i].filename               = "img_default_cont115ghz_jypxl.fits";
  ...
  img[i].source_vel             = 0;              // source velocity in m/s
  img[i].unit                   = 1;              // 0:Kelvin 1:Jansky/pixel 2:SI 3:Lsun/pixel 4:tau
  img[i].filename               = "img_default_CO_J1-0_LTE_jypxl_edgeon.fits"; //Output file
  ...
  img[i].source_vel             = 0;              // source velocity in m/s                                        
  img[i].unit                   = 1;              // 0:Kelvin 1:Jansky/pixel 2:SI 3:Lsun/pixel 4:tau                      
  img[i].filename               = "img_default_cont115ghz_jypxl_edgeon.fits";
